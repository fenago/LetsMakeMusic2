...
const Dash = ({ style, dashGap = 2, dashLength = 4, dashThickness = 2, dashColor = "#000", dashStyle, }) => {
    ...
    const measure = ({ nativeEvent: { layout: { width: LayoutWidth = 0, height: LayoutHeight = 0 } = {}, } = {}, }) => {
        setWidth(LayoutWidth);
        setHeight(LayoutHeight);
    };
    return (<View onLayout={measure} style={[style, isRow ? styles.row : styles.column]}>
      {arr}
    </View>);
};
export default Dash;
