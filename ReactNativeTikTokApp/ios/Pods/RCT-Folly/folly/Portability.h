...
// PATCHED: Disable coroutines for React Native compatibility with Xcode 26 beta
// RCT-Folly doesn't include coroutine implementation files
#if 1 || defined(FOLLY_CFG_NO_COROUTINES)
